<div id="pp" class="blog-single-post">
	...
	<div class="blog-single-content">
		...
		<ul>
			...
			<li>The paper must be sent through mail.
			<li>The instructions are as follows:</li>
			<ul>
				<li>The subject must be the title of the paper.</li>
				<li>The body of the mail should include - Participant and Institution's Name (starting from the first author and second one), Department and Year, Contact numbers,Email addresses.</li>
				<li>Send the paper to : <strong>hitsrevelation@gmail.com</strong></li>
			</ul> </li>
			<li>The Last date to send the paper: <strong>September,15 2016</strong></li>
			<li>Acceptance notification: <strong>September,16 2016</strong></li>
		</ul>
	</div>
</div>
