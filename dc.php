...
<div id="sp" class="blog-single-post">
	...
	<div class="post-header-image">
		<img src="img/dc.jpg" style="height:300px;width:300px;margin-left:260px;" alt="">
	</div>
	<!-- /post-image -->

	<!-- post title -->
	<h2 class="blog-single-title">Dumb C</h2>
	<!-- /post title -->

	<!-- post content -->
	<div class="blog-single-content">
		<p>Rules for Dumb Charades</p>
    ...
    <ul>
      ...
      <li>No lip movement or any sound is allowed.</li>
